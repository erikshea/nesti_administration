...
class UsersController extends EntityController
{
    ...
    public function actionAdd()
    {
        ...
        if ( !empty($_POST[$this->getEntityClass()]) ) { // if we arrived here by way of the submit button in the edit view
            ...
            if ($formBuilder->isValid() && FormBuilderValidator::passwordIsValid($formBuilder->getFormData()["password"])) {
    ...
    public function actionEdit()
    {
        ...
        if ( !empty($_POST[$this->getEntityClass()]) ) { // if we arrived here by way of the submit button in the edit view
            ...
            $formBuilder->setFormDataFromPost();
            $cityFormBuilder->setFormDataFromPost();

            if ($formBuilder->isValid() && $cityFormBuilder->isValid() && ( empty($formBuilder->getFormData()["newPassword"]) || FormBuilderValidator::passwordIsValid($formBuilder->getFormData()["newPassword"]))) {
                $formBuilder->applyDataTo($user);
